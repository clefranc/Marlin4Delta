...
#define DELTA
  ...
  #define DELTA_SMOOTH_ROD_OFFSET 175.0 // mm *JUST FOR REFERENCE/NOT USED IN CODE*

  // Horizontal offset of the universal joints on the carriages.
  #define DELTA_CARRIAGE_OFFSET 18.0 // mm *JUST FOR REFERENCE/NOT USED IN CODE*

  // Horizontal offset of the universal joints on the end effector.
  #define DELTA_EFFECTOR_OFFSET 33.0 // mm *JUST FOR REFERENCE/NOT USED IN CODE*
  ...
  //#define DELTA_RADIUS_A 124.0 // mm
  //#define DELTA_RADIUS_B 124.0 // mm
  //#define DELTA_RADIUS_C 124.0 // mm
  ...
  //#define DELTA_DIAGONAL_ROD_A 250.0 // mm
  //#define DELTA_DIAGONAL_ROD_B 250.0 // mm
  //#define DELTA_DIAGONAL_ROD_C 250.0 // mm
