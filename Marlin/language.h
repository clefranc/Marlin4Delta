...
#define MSG_M115_REPORT                     "FIRMWARE_NAME:" FIRMWARE_NAME " " SHORT_BUILD_VERSION " SOURCE_CODE_URL:" SOURCE_CODE_URL " CUSTOM_FIRMWARE_NAME:" CUSTOM_FIRMWARE_NAME " " CUSTOM_SHORT_BUILD_VERSION " CUSTOM_SOURCE_CODE_URL:" CUSTOM_SOURCE_CODE_URL " PROTOCOL_VERSION:" PROTOCOL_VERSION " MACHINE_TYPE:" MACHINE_NAME " EXTRUDER_COUNT:" STRINGIFY(EXTRUDERS) " UUID:" MACHINE_UUID "\n"
