...
#define MSG_M115_REPORT                     "FIRMWARE_NAME:Marlin " SHORT_BUILD_VERSION_CUSTOM " SOURCE_CODE_URL:" SOURCE_CODE_URL " PROTOCOL_VERSION:" PROTOCOL_VERSION " MACHINE_TYPE:" MACHINE_NAME " EXTRUDER_COUNT:" STRINGIFY(EXTRUDERS) " UUID:" MACHINE_UUID "\n"
