...
#define PROTOCOL_VERSION "1.0"
  ...
  #ifdef CUSTOM_SHORT_BUILD_VERSION
    #define STRING_SPLASH_LINE1 CUSTOM_SHORT_BUILD_VERSION
  #else
  ...
  #ifdef CUSTOM_STRING_DISTRIBUTION_DATE
    #define STRING_SPLASH_LINE2 CUSTOM_STRING_DISTRIBUTION_DATE
  #else
...
#define MSG_M115_REPORT                     "FIRMWARE_NAME:" FIRMWARE_NAME " " DETAILED_BUILD_VERSION " SOURCE_CODE_URL:" SOURCE_CODE_URL " CUSTOM_FIRMWARE_NAME:" CUSTOM_FIRMWARE_NAME " " CUSTOM_DETAILED_BUILD_VERSION " CUSTOM_SOURCE_CODE_URL:" CUSTOM_SOURCE_CODE_URL " PROTOCOL_VERSION:" PROTOCOL_VERSION " MACHINE_TYPE:" MACHINE_NAME " EXTRUDER_COUNT:" STRINGIFY(EXTRUDERS) " UUID:" MACHINE_UUID "\n"
